...
static const test_data_t test_data[] = {
    ...
    {1234567.0f,
     S21_CONVERSION_OK,
     {{1234567, 0, 0,
       S21_SIGN_POSITIVE}}},  // 10 Ровно 7 цифр - должно точно преобразоваться
    {1234567.8f,
     S21_CONVERSION_OK,
     {{1234568, 0, 0, S21_SIGN_POSITIVE}}},  // 11 8 цифр - должно округлиться
    {1234567.5f,
     S21_CONVERSION_OK,
     {{1234568, 0, 0, S21_SIGN_POSITIVE}}},  // 12 Ровно посередине - банковское
                                             // округление вверх
    {1234568.5f,
     S21_CONVERSION_OK,
     {{1234568, 0, 0, S21_SIGN_POSITIVE}}},  // 13  Ровно посередине -
                                             // банковское округление вниз
    // --- Ноль и близкие к нулю ---
    {0.0f, S21_CONVERSION_OK, {{0}}},                            // 14
    {-0.0f, S21_CONVERSION_OK, {{0, 0, 0, S21_SIGN_NEGATIVE}}},  // 15
    {1e-28f,
     S21_CONVERSION_OK,
     {{1, 0, 0, SCALE(28) | S21_SIGN_POSITIVE}}},  // 16
    {-1e-28f,
     S21_CONVERSION_OK,
     {{1, 0, 0, SCALE(28) | S21_SIGN_NEGATIVE}}},  // 17
    // --- Нормальные случаи ---
    // --- Целые числа ---
    ...
    {1.234567e19f,
     S21_CONVERSION_OK,
     {{1882349568U, 2874450292U, 0, S21_SIGN_POSITIVE}}},  // 22
    {1.234567e25f,
     S21_CONVERSION_OK,
     {{2841116672U, 479917308U, 669260U, S21_SIGN_POSITIVE}}},  // 23
    // --- Дробные числа ---
    {0.1f, S21_CONVERSION_OK, {{1, 0, 0, SCALE(1) | S21_SIGN_POSITIVE}}},  // 24
    {-0.5f,
     S21_CONVERSION_OK,
     {{5, 0, 0, SCALE(1) | S21_SIGN_NEGATIVE}}},  // 25
    {123.456f,
     S21_CONVERSION_OK,
     {{123456, 0, 0, SCALE(3) | S21_SIGN_POSITIVE}}},  // 26
    // --- Степени 10 ---
    {1e5f,
     S21_CONVERSION_OK,
     {{100000, 0, 0, S21_SIGN_POSITIVE}}},  // 27 100000
    {1e-5f,
     S21_CONVERSION_OK,
     {{1, 0, 0, SCALE(5) | S21_SIGN_POSITIVE}}},  // 28 0.00001
    {1e10f,
     S21_CONVERSION_OK,
     {{1410065408, 2, 0, S21_SIGN_POSITIVE}}}  // 29 10000000000
};
...
Suite* s21_add_float_to_decimal_suite(void) {
  ...
  tcase_add_loop_test(tc, test_float_to_decimal, 0,
